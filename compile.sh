...
gcc -Wall -pedantic -I./libraries -c ./libraries/sharedMemoryAdt.c -o ./libraries/sharedMemoryAdt.o

# Compile view
gcc -Wall -pedantic -I./libraries ./view/view.c ./libraries/sharedMemory.o -o executables/view -pthread -lrt

# Compile player
gcc -Wall -pedantic -I./libraries ./player/player.c ./libraries/sharedMemoryAdt.o -o executables/player -pthread -lrt
